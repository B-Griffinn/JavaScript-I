...
for(let i=0; i <= inventory.length; i++) {    
    if(inventory[i].id === 33) {
      recall = `Car 33 is a *${inventory[i].car_year}* *${inventory[i].car_make}* *${inventory[i].car_model}*`;
...
console.log(`The last car is ${lastCar.car_make } ${lastCar.car_model}`);
...
console.log(oldCars.length); //25 cars older than 2000
